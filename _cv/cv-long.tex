...
\begin{document}
    ...
    Features:
    Order Management System, turnkey, including frontend: JSF, Primefaces and Backend: JPA, Hibernate, MySQL
    ...
    Built a maintainable and efficient layers of tests, both unit and integration.
    Participated in code reviews.
    Planned sprints for implementing new features.
    Lead a team of several software developers.
    Deployed and supported the system.
    Java, Java‐EE, Vaadin, JPA, Hibernate, MySQL, Jasper Reports, Apache-Poi, JUnit, Mockito.
